"""
Nombre del programa: textures2d.py
 Función: Realización de textura bidimensional y mezcla de colores.
...
shader = compileProgram(compileShader(vertex_src, GL_VERTEX_SHADER), compileShader(fragment_src, GL_FRAGMENT_SHADER))
 ...
 # Paso 2: crear y vincular objetos VBO para transferir datos
VBO = glGenBuffers(1)
glBindBuffer(GL_ARRAY_BUFFER, VBO)
glBufferData(GL_ARRAY_BUFFER, vertices.nbytes, vertices, GL_STATIC_DRAW)
 
 # Paso 3: Cree y vincule el objeto EBO para transferir datos
EBO = glGenBuffers(1)
glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, EBO)
glBufferData(GL_ELEMENT_ARRAY_BUFFER, indices.nbytes, indices, GL_STATIC_DRAW)
 # Paso 4: Especifique el método de resolución y habilite los atributos de vértice
 # Atributos de posición de vértice 
glEnableVertexAttribArray(0)
glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, vertices.itemsize * 8, ctypes.c_void_p(0))
 # Atributos de color de vértice
